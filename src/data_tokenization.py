...
DATA_FILE = "/mnt/parscratch/users/ac1xwa/pythia/pre-train_data_csv/ArXiv_sampled.csv"  # Path to your text dataset
...
TOKENISED_DATASET_PATH = "/mnt/parscratch/users/ac1xwa/pythia/pre-train_data_csv/tokenized_arxiv_sampled"
